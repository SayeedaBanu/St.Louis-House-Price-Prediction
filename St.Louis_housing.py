"""Load the St.Louis dataset and examine its target (label) distribution."""
...
def load_data():
    ...
    louis = datasets.load_louis()
    return louis


def explore_city_data(city_data):
    """Calculate the St.Louis housing statistics."""
...
def split_data(city_data):
    ...
    # Get the features and labels from the St. Louis housing data
...
def main():
    """Analyze the St. Louis housing data. Evaluate and validate the
